...
public class InventoryProvider extends ContentProvider {
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(EmployeeContract.EmployeeEntry.COLUMN_SUPPLIER_NAME)) {
            String name = values.getAsString(EmployeeContract.EmployeeEntry.COLUMN_SUPPLIER_NAME);
            if (name == null) {
                throw new IllegalArgumentException("PRODUCT requires a supplier name");
            }
        }
        if (values.containsKey(EmployeeContract.EmployeeEntry.COLUMN_SUPPLIER_CONTACT)) {
            String name = values.getAsString(EmployeeContract.EmployeeEntry.COLUMN_SUPPLIER_CONTACT);
            if (name == null) {
                throw new IllegalArgumentException("PRODUCT requires a Supplier name");
            }
        }
